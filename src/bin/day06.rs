...
fn main() {
    ...
    dbg!(laternfish_count(&ages, 80));
    dbg!(laternfish_count(&ages, 256));
    dbg!(laternfish_count(&ages, 1_000_000_000)); // just to test time complexity
}

fn laternfish_count(ages: &[usize], days: usize) -> usize {
